        ...
        if actor_1 and actor_2:
            if actor_1 != actor_2:
                ...
                if peliculas_encontradas:
                    ...
                    QMessageBox.warning(self, "Resultado", "No se encontraron películas con esos actores.")
            else:
                QMessageBox.warning(self, "Error", "Los actores no pueden ser los mismos.")
        else:
            QMessageBox.warning(self, "Error", "Por favor, ingrese ambos nombres de actores.")
