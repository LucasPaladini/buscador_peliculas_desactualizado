...
class Ui_Ventana_principal(object):
    def setupUi(self, Ventana_principal):
        ...
        self.boton_buscar_nombre = QPushButton(self.centralwidget)
        self.boton_buscar_nombre.setObjectName(u"boton_buscar_nombre")

        self.gridLayout.addWidget(self.boton_buscar_nombre, 2, 1, 1, 1)
    ...
    def retranslateUi(self, Ventana_principal):
        ...
        self.boton_buscar_nombre.setText(QCoreApplication.translate("Ventana_principal", u"Buscar", None))
        self.label.setText(QCoreApplication.translate("Ventana_principal", u"Busqueda de pel\u00edculas", None))
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("Ventana_principal", u"Buscar actor 2", None))
